...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`${styles.bar} md:py-5 py-3 px-6 md:px-0 backdrop-blur-md z-50`}
      >
        <div className="md:px-12 mx-auto">
          <div className="flex justify-between relative  z-30">
            ...
            <div className="md:flex hidden space-x-3 items-center">
              ...
              <AnchorLink className={styles.link} href="#knowlodge">
                Knowledge
              </AnchorLink>
              <AnchorLink className={styles.link} href="#projects">
                Projects
              </AnchorLink>
      ...
      <aside
        className={
          menuActive
            ? `${styles.mobile} ${styles.on} backdrop-blur-md`
            : `${styles.mobile}`
        }
      >
